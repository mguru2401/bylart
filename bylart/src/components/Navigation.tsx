    ...
    >
      <div className="w-full px-6 lg:px-12">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden lg:flex items-center space-x-1">
            ...
            <a
              href="mailto:getintouch@bylart.com"
              className={`ml-4 px-6 py-2.5 rounded-full font-bold transition-all duration-300 transform hover:scale-105 ${
                isScrolled
      ...
      >
        <div className="overflow-y-auto h-full p-6">
          ...
          <a
            href="mailto:getintouch@bylart.com"
            className="block mt-6 w-full text-center py-3 bg-emerald-600 text-white rounded-xl font-bold hover:bg-emerald-700 transition-colors shadow-md"
          >
            Contact Us
          </a>
        </div>
